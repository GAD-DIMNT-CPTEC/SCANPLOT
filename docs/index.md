...
Nesta página, a apresentação das funções de plotagem é feita com base nas seções do notebook do SCANPLOT disponível em https://github.com/cfbastarz/SCANPLOT/blob/master/SCANPLOT.ipynb.
